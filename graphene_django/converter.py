...
def convert_django_field_with_choices(field, registry=None):
    ...
    if choices:
        ...
        converted = enum(description=field.help_text, required=not field.blank)
    else:
...
def convert_field_to_uuid(field, registry=None):
    return UUID(description=field.help_text, required=not field.blank)
...
def convert_time_to_string(field, registry=None):
    return Time(description=field.help_text, required=not field.blank)
...
def convert_onetoone_field_to_djangomodel(field, registry=None):
    ...
    def dynamic_type():
        ...
        return Field(_type, required=not blank)
...
def convert_field_to_djangomodel(field, registry=None):
    ...
    def dynamic_type():
        ...
        return Field(_type, description=field.help_text, required=not field.blank)
...
def convert_postgres_array_to_list(field, registry=None):
    ...
    return List(base_type, description=field.help_text, required=not field.blank)
...
def convert_posgres_range_to_string(field, registry=None):
    ...
    return List(inner_type, description=field.help_text, required=not field.blank)
